...
//! assert!(emphasis.attrs.contains(Attributes::BOLD | Attributes::ITALIC));
...
impl Attributes {
    ...
    /// `const` / builder context: `attrs.insert(Attributes::BOLD)` adds a flag without
    ...
    ///
    /// The complement of [`insert`](Self::insert): `attrs.remove(Attributes::BOLD)`
    ...
    /// renderer rebuilt the set from the known flags because `Attributes` had only
    /// `|`).
    ///
    /// # Examples
    ///
    ...
    /// use rabbitui_core::style::Attributes;
    ///
    /// let attrs = (Attributes::BOLD | Attributes::ITALIC).remove(Attributes::BOLD);
    /// assert!(attrs.contains(Attributes::ITALIC));
    /// assert!(!attrs.contains(Attributes::BOLD));
    /// ```
    #[must_use]
...
impl Style {
    ...
    pub const fn bold(mut self) -> Self {
        self.attrs = Attributes(self.attrs.0 | Attributes::BOLD.0);
        self
    }
    ...
    pub const fn dim(mut self) -> Self {
        self.attrs = Attributes(self.attrs.0 | Attributes::DIM.0);
        self
    }
    ...
    pub const fn italic(mut self) -> Self {
        self.attrs = Attributes(self.attrs.0 | Attributes::ITALIC.0);
        self
    }
    ...
    pub const fn underline(mut self) -> Self {
        self.attrs = Attributes(self.attrs.0 | Attributes::UNDERLINE.0);
        self
    }
    ...
    pub const fn reversed(mut self) -> Self {
        self.attrs = Attributes(self.attrs.0 | Attributes::REVERSED.0);
        self
    }
    ...
    /// assert!(resolved.attrs.contains(Attributes::BOLD | Attributes::ITALIC));
    ...
    pub const fn merge_over(self, base: Self) -> Self {
        Self {
            ...
            attrs: Attributes(self.attrs.0 | base.attrs.0),
        }
    }
}
...
mod tests {
    ...
    fn insert_adds_a_flag() {
        ...
        assert_eq!(attrs.insert(Attributes::BOLD), attrs);
    }

    #[test]
    fn remove_clears_a_flag_and_leaves_the_rest() {
        let attrs = (Attributes::BOLD | Attributes::ITALIC | Attributes::UNDERLINE)
            .remove(Attributes::ITALIC);
        assert!(attrs.contains(Attributes::BOLD));
        assert!(attrs.contains(Attributes::UNDERLINE));
        assert!(!attrs.contains(Attributes::ITALIC));
        // Removing an absent flag is a no-op.
        assert_eq!(attrs.remove(Attributes::STRIKETHROUGH), attrs);
    }

    #[test]
    fn bitand_is_the_intersection() {
        let left = Attributes::BOLD | Attributes::ITALIC;
        let right = Attributes::ITALIC | Attributes::UNDERLINE;
        assert_eq!(left & right, Attributes::ITALIC);
        let mut acc = left;
        acc &= right;
        assert_eq!(acc, Attributes::ITALIC);
    }
    ...
    fn not_complements_only_defined_flags() {
        ...
        assert_eq!(!Attributes::NONE, Attributes::ALL);
        assert_eq!(!Attributes::ALL, Attributes::NONE);
        // `attrs & !other` is exactly `attrs.remove(other)`.
        let attrs = Attributes::BOLD | Attributes::ITALIC;
        assert_eq!(attrs & !Attributes::BOLD, attrs.remove(Attributes::BOLD));
    }
}
