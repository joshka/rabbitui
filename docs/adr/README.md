...
One ADR per decision: context, options with steelmen, decision, honest consequences, and concrete
revisit triggers. Decisions change by supersession, never silent edits. `DESIGN.md` at the workspace
root is the narrative summary.
